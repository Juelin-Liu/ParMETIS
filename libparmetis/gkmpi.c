        ...
        MPI_Comm comm)
{
  ...
  return MPI_Alltoallv(sendbuf, sendcounts, sdispls, sendtype, 
               recvbuf, recvcounts, rdispls, recvtype, comm);
#else
  return MPI_Alltoallv_c(sendbuf, (const MPI_Count *)sendcounts, sdispls, sendtype, 
               recvbuf, (const MPI_Count *)recvcounts, rdispls, recvtype, comm);
#endif
#endif
}
        ...
        MPI_Datatype recvtype, MPI_Comm comm)
{
  ...
  return MPI_Allgatherv_c(sendbuf, sendcount, sendtype, recvbuf, 
               (const MPI_Count *)recvcounts, rdispls, recvtype, comm);
#endif
#endif
}
        ...
        MPI_Datatype recvtype, idx_t root, MPI_Comm comm)
{
  ...
  return MPI_Scatterv(sendbuf, sendcounts, sdispls, sendtype, 
               recvbuf, recvcount, recvtype, root, comm);
#else
  return MPI_Scatterv_c(sendbuf, (const MPI_Count *)sendcounts, sdispls, sendtype, 
               recvbuf, recvcount, recvtype, root, comm);
#endif
#endif
}
        ...
        idx_t root, MPI_Comm comm)
{
  ...
  return MPI_Gatherv_c(sendbuf, sendcount, sendtype, recvbuf, 
               (const MPI_Count *)recvcounts, rdispls, recvtype, root, comm);
#endif
#endif
}
